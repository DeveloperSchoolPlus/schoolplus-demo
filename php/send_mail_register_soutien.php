<?php
  ...
  $email_message .= "</i></p><p>Cliquez sur ce <a href='http://hackschooling.myschool.plus/pages/fr/register-soutien.php'>lien</a> pour vous inscrire et créer votre compte.</p>";
