      ...
      uploadTask.snapshot.ref.getDownloadURL().then(function(url) {
        ...
        document.getElementById('evalPresent').style.display = 'block';
         ...
         var newNotif = {
          ...
          description: {en: '<b>' + '</b> sent you a message. Go to the inbox corresponding to your email address (<i>' + 'la' + '</i>) to answer the message.', fr: 'Une nouvelle <b>évaluation</b> a été ajoutée pour le <b>'+document.getElementById('chapterNumber').innerText+'</b> en <b>'+$('select#selectMatiere').val()+'</b>. Rendez-vous sur la page <i>Mes cours</i>pour la télécharger.'},
          url: "#"
        }
...
function closeChapter(chapter) {
  ...
  const studentsListHtml0bis = '<fieldset class="form-group floating-label-form-group"><div class="row"><div class="col-xl-8 col-md-8 col-sm-8"><label class="card-title text-bold-600">Pour toute la classe</label></div><div class="col-xl-4 col-md-4 col-sm-4" style="text-align:center"><div class="help-block text-bold-600 text-success font-small-3"><i class="far fa-check-circle"></i> Chapitre terminé.</div></div></div></fieldset><span class="hidden" id="closingChapterNumber">' + chapter + '</span><br>';
