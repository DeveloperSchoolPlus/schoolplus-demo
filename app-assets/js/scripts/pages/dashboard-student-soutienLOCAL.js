...
function toDoList(numeroChapitre) {
  ...
  firestore.collection('users').doc($('select#selectModifyStudent').val()).collection($('select#selectModifyMatiere').val()).doc(numeroChapitre).get()
    .then(function (doc2) {
      ...
      pdfCoursUrl = 'fiches_cours/' + user.uid + '_' + $('select#selectModifyStudent').val() + '_' + nomMatiere + '_' + newNumeroChapitre + ".pdf";
      pdfExercicesUrl = 'fiches_exos/' + user.uid + '_' + $('select#selectModifyStudent').val() + '_' + nomMatiere + '_' + newNumeroChapitre + ".pdf";
      ...
      var sujetEvalUrl = 'sujets_evaluations/' + user.uid + '_' + $('select#selectModifyStudent').val() + '_' + nomMatiere + '_' + newNumeroChapitre + '.pdf';
      ...
      var correctionExosUrl = 'exos_corriges/' + user.uid + '_' + $('select#selectModifyStudent').val() + '_' + nomMatiere + '_' + newNumeroChapitre + '.pdf';
