...
function setUserNavBAr(userCategory, soutien) {
  ...
  if(userCategory == 'teacher')
  {
    ...
    rightMenu.innerHTML += '<a href="personnel-etablissement.php" class="dropdown-item"><i class="fas fa-users"></i> Personnel établissement</a>';
      ...
      rightMenu.innerHTML = '<a href="mes-eleves.php" class="dropdown-item"><i class="fas fa-users"></i> Mes élèves</a>';
      rightMenu.innerHTML += '<a href="mes-eleves-soutien.php" class="dropdown-item active"><i class="fas fa-users"></i> Mes élèves - Soutien</a>';
      rightMenu.innerHTML += '<a href="personnel-etablissement.php" class="dropdown-item"><i class="fas fa-users"></i> Personnel établissement</a>';
  ...
  else if(userCategory == 'admin')
  {
    ...
    var right2 = '<a href="#" class="dropdown-item active" style="background:whitesmoke"><i class="fas fa-users"></i> Mes élèves - Soutien</a>';
    ...
    if(docUser.data().userCategory == 'teacher')
    {
      ...
      .then(function(querySnapshot) {
        querySnapshot.forEach(function(doc) {
          ...
          switch(doc.data().userCategory) {
            ...
            break;
            case 'admin':
            var category = "Chef d'établissement";
            break;
          }
      ...
      .then(function(querySnapshot) {
        ...
        .then(function(docAdmin) {
          ...
          var totalHTML = listFollowingHtml1 +docAdmin.id+ listFollowingHtml2 +docAdmin.id + listFollowingHtml3 + docAdmin.data().firstName + " " + docAdmin.data().lastName +listFollowngHtml+"Chef d'établissement"+ listFollowingHtml4 +docAdmin.id+ listFollowingHtml5 +docAdmin.id+ listFollowingHtml6
          document.getElementById('list-following').innerHTML += totalHTML;
