...
var classValue;
const instituteLevels = ['6ème', '5ème', '4ème', '3EVOL', '2EVOL', '1EVOL', '1STMG_EVOL', 'T_EVOL', 'TSTMG_EVOL', 'Terminale Pro Commerce'];
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function createRecurringEvents(userID, instituteName, userCategory, eventType, description, color, startEventArray, endEventArray, classe, matiere, attendeesID, teacherID, index, groupID, startRecur, endRecur, calendar) {
    ...
    if (index < startEventArray.length) {
      ...
      query.set({
        ...
        if (userCategory == "teacher") {
          ...
          firestore.collection('activities').doc(teacherID + "_" + startEventArray[index] + "_" + classe + "_" + classValue + "_" + matiere)
            .set({
              ...
              if (attendeesID.includes("classe") && attendeesID.length == 1) {
                    ...
                    querySnapshot.forEach(function (doc) {
                      firestore.collection('activities').doc(doc.id + "_" + startEventArray[index] + "_" + classe + "_" + classValue + "_" + matiere)
                        .set({
                          ...
                          var title = "Une erreur est survenue lors de la création de l'événement réccurent d'un des Étudiants. Veuillez recommencer. Si le problème persiste, vous pouvez contacter le service technique de la plateforme.";
                ...
                firestore.collection('activities').doc(attendeesID + "_" + startEventArray[index] + "_" + classe + "_" + classValue + "_" + matiere)
                  .set({
                    ...
                    var title = "Une erreur est survenue lors de la création de l'événement réccurent de l'Étudiant. Veuillez recommencer. Si le problème persiste, vous pouvez contacter le service technique de la plateforme.";
                    alertSwal(title, typeError);
                  });
              } else if (!attendeesID.includes("classe") && attendeesID.length > 1) {
              ...
              var title = "Une erreur est survenue lors de la création de l'événement réccurent du Professeur. Veuillez recommencer. Si le problème persiste, vous pouvez contacter le service technique de la plateforme.";
              alertSwal(title, typeError);
            });
        }
      }).catch(function (err) {
        ...
        var title = "Une erreur est survenue lors de la création de l'événement réccurent de l'Administrateur. Veuillez recommencer. Si le problème persiste, vous pouvez contacter le service technique de la plateforme.";
        alertSwal(title, typeError);
      });
  ...
  function initCalendar(userCategory, instituteName, classValue, idStud) {
    ...
    if (userCategory == 'admin') {
      ...
      document.getElementById('modalTitle').innerText = "Ajouter un événenement - " + classValue;
    }
            ...
            $("#formEvent").submit(function (ev) {  //Once the form is submitted
              ...
              if ($('select#selectRecur').val() == "non") {
                ...
                query.set({
                  ...
                  if (userCategory == "admin") {
                    ...
                    firestore.collection('activities').doc($('select#selectTeacher').val() + "_" + startEvent + "_" + $('select#selectClass').val() + "_" + classValue + "_" + $('select#selectMatiere').val())
                      .set({
                        ...
                        if ($('select#selectStudent').val().includes("classe") && $('select#selectStudent').val().length == 1) {
                              ...
                              querySnapshot.forEach(function (doc) {
                                firestore.collection('activities').doc(doc.id + "_" + startEvent + "_" + $('select#selectClass').val() + "_" + classValue + "_" + $('select#selectMatiere').val())
                                  .set({
                                    ...
                                    var title = "Une erreur est survenue lors de la création de l'événement d'un des Étudiants'. Veuillez recommencer. Si le problème persiste, vous pouvez contacter le service technique de la plateforme.";
                                    alertSwal(title, typeError);
                                  });
                              });
                            }).catch(function (err) {
                          ...
                          firestore.collection('activities').doc($('select#selectStudent').val() + "_" + startEvent + "_" + $('select#selectClass').val() + "_" + classValue + "_" + $('select#selectMatiere').val())
                            .set({
                              ...
                              var title = "Une erreur est survenue lors de la création de l'événement de l'Étudiant. Veuillez recommencer. Si le problème persiste, vous pouvez contacter le service technique de la plateforme.";
                              alertSwal(title, typeError);
                            });
                        } else if (!$('select#selectStudent').val().includes("classe") && $('select#selectStudent').val().length > 1) {
                          //A group of student is selected, but not the whole class
                        ...
                        var title = "Une erreur est survenue lors de la création de l'événement du Professeur. Veuillez recommencer. Si le problème persiste, vous pouvez contacter le service technique de la plateforme.";
                        alertSwal(title, typeError);
                      });
                  }
                }).catch(function (err) {
                  ...
                  var title = "Une erreur est survenue lors de la création de l'événement de l'Administrateur. Veuillez recommencer. Si le problème persiste, vous pouvez contacter le service technique de la plateforme.";
                  alertSwal(title, typeError);
                });
                                ...
                                querySnapshot.forEach(function (doc2) {
                                  ...
                                  firestore.collection('activities').doc(doc2.data().id)
                                    .set({
                                      ...
                                      var title = "Une erreur est survenue lors de la modification de l'événement. Veuillez recommencer. Si le problème persiste, vous pouvez contacter le service technique de la plateforme.";
                                      alertSwal(title, typeError);
                                    });
                                });
