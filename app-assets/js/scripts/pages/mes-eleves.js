...
function setUserNavBAr(userCategory, soutien) {
  ...
  if(userCategory == 'teacher')
  {
    ...
    rightMenu.innerHTML = '<a href="mes-eleves.php" class="dropdown-item active"><i class="fas fa-users"></i> Mes élèves</a>';
  ...
  else if(userCategory == 'admin')
  {
    ...
    var right1 = '<a href="#" class="dropdown-item active" style="background:whitesmoke"><i class="fas fa-users"></i> Mes élèves</a>';
...
function initUserCards() {
  ...
  .then(function(docUser) {
    ...
    if(docUser.data().userCategory == 'teacher')
    {
      ...
      firestore.collection('users').where('instituteName', '==', docUser.data().instituteName).where('classe', 'in', docUser.data().classe).where('userCategory','==', 'student').get()
        ...
        querySnapshot.forEach(function(doc) {
          ...
          if(!docUser.data().dev && docUser.data().dev != undefined)
          {
            if(!docUser.data().testAccounts.includes(doc.id))
            {
              ...
              var totalHTML = listFollowingHtml1 +doc.id+ listFollowingHtml2 +doc.id + listFollowingHtml3 + doc.data().firstName + " " + doc.data().lastName +listFollowngHtml+doc.data().classe+ listFollowingHtml4 +doc.id+ listFollowingHtml5 + listFollowingHtml6
      ...
      .then(function(querySnapshot) {
        ...
        querySnapshot.forEach(function(docStudent) {
              ...
              if(docStudent.data().soutien != true)
          {
            ...
            var totalHTML = listFollowingHtml1 +docStudent.id+ listFollowingHtml2 +docStudent.id + listFollowingHtml3 + docStudent.data().firstName + " " + docStudent.data().lastName +listFollowngHtml+docStudent.data().classe+ listFollowingHtml4 +docStudent.id+ listFollowingHtml5 + listFollowingHtml6
            document.getElementById('list-following').innerHTML += totalHTML;
          }
            }
          }
