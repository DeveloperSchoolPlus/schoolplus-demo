...
<body id="page-body" data-open="hover" data-menu="horizontal-menu" data-col="2-columns" class="horizontal-layout horizontal-menu 2-columns">
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="nav navbar-nav">
          <li data-menu="dropdown" class="dropdown nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="fas fa-school"></i><span data-i18n="nav.dash.main">Gestion EVOL</span></a>
            <ul class="dropdown-menu">
              ...
              <!--  -->
              <li data-menu="" class="dropdown  dropdown-item dropdown-submenu">
              <a class="dropdown-toggle dropdown-item-submenu" data-toggle="dropdown"><span data-i18n="nav.dash.main">Gestions utilisateurs</span></a>
              <ul class="dropdown-menu">
  ...
  <div class="app-content container center-layout mt-2">
    ...
    <div id="addUser" style="display: none;">
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block"><i class="fas fa-user-plus"></i> Ajouter un compte utilisateur <a href="#" id="help"><i class="fas fa-question-circle inline-block" style="font-weight: 100"></i></a></h3>
      </div>
          ...
          <div class="col-xs-12">
            <div class="card">
              ...
              <div class="card-block">
                <form id="createUserForm" class="form-horizontal" method="post" action="../../php/send_mail_register_soutien.php" target="hiddenFrame">
                  <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-">
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" name="createLastName" id="createLastName" class="form-control input-lg" placeholder="Nom" tabindex="2" required />
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" name="createFirstName" id="createFirstName" class="form-control input-lg" placeholder="Prénom" tabindex="3" required>
                        <div class="form-control-position">
                          <i class="icon-head"></i>
                        </div>
                        <div class="help-block text-bold-600 danger font-small-3"></div>
                  ...
                  <div class="form-group">
                    <select id="selectType" class="selectize-select selectized" tabindex="-1" style="display: none;">
                      <option value="" selected="selected" disabled>Catégories d'utilisateurs</option>
                      <option value="student">Élève</option>
                      <option value="teacher">Professeur</option>
                    </select>
                  </div>
                  <fieldset class="form-group position-relative has-icon-left">
                    <input type="email" name="createAdresse" id="createAdresse" class="form-control input-lg" placeholder="Adresse mail" tabindex="4" required data-validation-required-message="Entrez une adresse mail.">
                    <div class="form-control-position">
                  ...
                  <button id="btnValidateForm" type="button" class="btn bg-school-plus btn-block btn-lg text-bold-600"><i class="fas fa-user-plus"></i> Ajouter l'utilisateur</button>
                </form>
              </div>
            </div>
          </div>
      ...
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block"><i class="fas fa-user-edit"></i> Modification de compte utilisateur <a href="#" id="help"><i class="fas fa-question-circle inline-block" style="font-weight: 100"></i></a></h3>
      </div>
      <div class="content-body">
        <div class="row">
          <div class="col-xs-12">
            <div class="card">
              ...
              <div class="card-block">
                <form id="modifyUserForm" class="form-horizontal" action="#" novalidate method="POST">
                  <div class="form-group">
                    <select id="selectModifyUser" class="selectize-select selectized" tabindex="-1" style="display: none;" required>
                      <option value="" selected="selected" disabled>Choisissez le compte utilisateur à modifier</option>
                    </select>
                  </div>
                  <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-">
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" name="modifyLastName" id="modifyLastName" class="form-control input-lg" placeholder="Nom" tabindex="2" required>
                        <div class="form-control-position">
                          <i class="icon-head"></i>
                        </div>
                        <div class="help-block text-bold-600 danger font-small-3"></div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" name="modifyFirstName" id="modifyFirstName" class="form-control input-lg" placeholder="Prénom" tabindex="3" required>
                        <div class="form-control-position">
                          <i class="icon-head"></i>
                        </div>
                        <div class="help-block text-bold-600 danger font-small-3"></div>
                  ...
                  <div class="form-group">
                    <select id="selectModifyType" class="selectize-select selectized" tabindex="-1" style="display: none;">
                      <option value="" selected="selected" disabled>Catégories d'utilisateurs</option>
                      <option value="student">Élève</option>
                      <option value="teacher">Professeur</option>
                    </select>
                  ...
                  <fieldset class="form-group position-relative has-icon-left">
                    <input type="email" name="modifyAdresse" id="modifyAdresse" class="form-control input-lg" placeholder="Adresse mail" tabindex="4" required data-validation-required-message="Entrez une adresse mail.">
                    <div class="form-control-position">
                      <i class="icon-mail6"></i>
                    </div>
                    <div class="help-block text-bold-600 danger font-small-3"></div>
                  </fieldset>
                  <button type="button" id="btnValidateModifyForm" class="btn bg-school-plus btn-block btn-lg text-bold-600"><i class="icon-head"></i> Modifier</button>
                </form>
              </div>
            </div>
          </div>
      ...
      <!-- 3  -->
      <div id="modifyStudent" style="display: none;">
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
      ...
      <!-- 4 -->
      <div id="soutienTeacher" style="display: none;">
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block"><i class="fas fa-user-plus"></i> Passage en compte Soutien Scolaire <a href="#" id="help"><i class="fas fa-question-circle inline-block" style="font-weight: 100"></i></a></h3>
      </div>
      <div class="content-body">
        <div class="row">
          <div class="col-xs-12">
            <div class="card">
              ...
              <div class="card-block">
                <form id="soutienScolaireForm" class="form-horizontal" method="post"  target="hiddenFrame">
                  <div class="row">
                   <!--  <div class="col-xs-12 col-sm-6 col-md-">
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" name="createLastName" id="createLastName" class="form-control input-lg" placeholder="Nom" tabindex="2" required />
                  ...
                  <div class="form-group">
                    <select id="selectTeacher" class="selectize-select selectized" tabindex="-1" style="display: none;" required>
                      <option value="" selected="selected" disabled>Professeurs de l'établissement</option>
                      <!-- <option value="student">Élève</option>
                      <option value="teacher">Professeur</option> -->
                    </select>
                  </div>
                  ...
                  <button id="btnSoutien" type="button" class="btn bg-school-plus btn-block btn-lg text-bold-600"><i class="fas fa-user-plus"></i> Attribuer les fonctionnalités du soutien scolaire</button>
                </form>
              </div>
            </div>
          </div>
  ...
  <script type="text/javascript" src="../../app-assets/js/scripts/pages/create-user-soutien.js"></script>
