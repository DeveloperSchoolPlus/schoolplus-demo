...
<body data-open="click" data-menu="vertical-overlay-menu" data-col="1-column" class="vertical-layout vertical-overlay-menu 1-column  blank-page blank-page" style="background:url(../../app-assets/images/backgrounds/schoolplusbackground.png) no-repeat center center fixed; background-size: cover">
            ...
            <div class="card-header no-border pb-0">
              ...
              <div class="text-bold-600 danger font-small-3" style="display:none; text-align:center" id="error-message-1">
                ...
                <fieldset class="form-group position-relative has-icon-left">
                    ...
                    <button type="button" id="btnVerifyEmail" class="btn bg-school-plus btn-block btn-lg text-bold-600"><i class="fas fa-user-check"></i> Vérifier l'adresse</button>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-">
                        ...
                        <fieldset class="form-group position-relative has-icon-left">
                          <input type="text" name="lastname" id="lastname" class="form-control input-lg" placeholder="Nom" tabindex="1" required>
                          <div class="form-control-position">
                            <i class="icon-head"></i>
                          </div>
                          <div class="help-block text-bold-600 danger font-small-3"></div>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-6">
                        <fieldset class="form-group position-relative has-icon-left">
                          <input type="text" name="firstname" id="firstname" class="form-control input-lg" placeholder="Prénom" tabindex="2" required>
                          <div class="form-control-position">
                            <i class="icon-head"></i>
                          </div>
                          <div class="help-block text-bold-600 danger font-small-3"></div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-6">
                        <fieldset class="form-group position-relative has-icon-left">
                          <input type="password" name="password_confirmation" id="password_confirmation" class="form-control input-lg" placeholder="Confirmez le mot de passe." tabindex="7" required data-validation-matches-match="password" data-validation-matches-message="Mot de passe différent.">
                          <div class="form-control-position">
                            <i class="icon-key3"></i>
                          </div>
                          <div class="help-block text-bold-600 danger font-small-3"></div>
                    ...
                    <button type="submit" id="btnRegister" class="btn bg-school-plus btn-block btn-lg text-bold-600" disabled="true"><i class="icon-head"></i> M'inscrire</button>
                  </form>
                  </div>  
  ...
  <script src="../../app-assets/js/scripts/pages/register-soutien.js" type="text/javascript"></script>
  <!-- END PAGE LEVEL JS-->
</body>
