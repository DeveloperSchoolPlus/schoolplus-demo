...
<head>
 ...
 <?php include '../../../bibliotheque/modules/users/modify-user/css.php' ?>
...
<body class="vertical-layout vertical-compact-menu content-detached-right-sidebar   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-compact-menu" data-col="content-detached-right-sidebar">
 ...
 <?php
    ...
    ?>
 <!-- end vertical-menu -->
 <?php include '../../../bibliotheque/modules/users/modify-user/main.php' ?>
 ...
 <?php include '../../../bibliotheque/modules/users/modify-user/scripts.php' ?>
 <script src="modify-userV2.js"></script>
