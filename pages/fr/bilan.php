...
<body id="page-body" data-open="hover" data-menu="horizontal-menu" data-col="2-columns" class="horizontal-layout horizontal-menu 2-columns">
          ...
          <ul class="nav navbar-nav float-xs-right">
            ...
            <li class="dropdown dropdown-user nav-item">
              ...
              <div class="dropdown-menu dropdown-menu-right ">
                <a href="user-profile.php" class="dropdown-item"><i class="fas fa-user"></i> Voir Profil</a><div id="rightMenu">
      ...
      <div data-menu="menu-container" class="navbar-container main-menu-content container center-layout">
        ...
        <li data-menu="dropdown" class="dropdown nav-item active"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="fas fa-school"></i><span data-i18n="nav.dash.main">Gestion EVOL</span></a>
            <ul class="dropdown-menu">
              <li data-menu=""><a href="dashboard.php" class="dropdown-item"><span data-i18n="nav.dash.main">Plannings</span></a>
              </li>
  ...
  <div class="app-content container center-layout mt-2">
    ...
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
      ...
      <!-- MODAL -->
      <div class="modal fade text-left" id="modalImplication" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" style="display: none;"
          aria-hidden="true">
              ...
              <div class="card-body collapse in">
                <div class="card-block">
                  ...
                  <div style='text-align: center;'>
                    ...
                    <button style="float: right;" class="btn bg-school-plus btn-min-width text-bold-600" onclick="showImplication();"
                      type="button">Afficher les notes d'implication</button>
      ...
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        ...
        <div class="form-group">
          <select id="selectCorrectionClasse" class="selectize-select selectized" tabindex="-1" style="display: none;" required>
            <option value="" selected="selected" disabled>Choisissez une classe</option>
          </select>
        </div>
  ...
  <script src="../../app-assets/js/scripts/pages/bilan.js"></script>
