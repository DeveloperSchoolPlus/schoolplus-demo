...
<body id="page-body" data-open="hover" data-menu="horizontal-menu" data-col="2-columns" class="horizontal-layout horizontal-menu 2-columns ">
          ...
          <ul class="nav navbar-nav float-xs-right">
            ...
            <li class="dropdown dropdown-user nav-item">
              ...
              <div class="dropdown-menu dropdown-menu-right ">
                ...
                <div id="rightMenuAdmin" style="display: none;">
                ...
                <div id="rightMenuTeacher" style="display: none;">
                  <a href="mes-eleves.php" class="dropdown-item"><i class="fas fa-users"></i> Mes élèves</a>
                  <a href="personnel-etablissement.php" class="dropdown-item"><i class="fas fa-users"></i> Personnel établissement</a>
                </div>
                <div id="rightMenuSoutienTeacher" style="display: none;">
                <a href="mes-eleves-soutien.php" class="dropdown-item"><i class="fas fa-users"></i> Mes élèves</a>
                  <a href="personnel-etablissement.php" class="dropdown-item"><i class="fas fa-users"></i> Personnel établissement</a>
              </div>
                <div id="rightMenuStudent" style="display: none;">
                <a href="mes-profs.php" class="dropdown-item"><i class="fas fa-users"></i> Mes profs</a>
              </div>
                <div id="rightMenuSoutienStudent" style="display: none;">
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="nav navbar-nav">
          <div id="adminSection" style="display: none;">
            <li data-menu="dropdown" class="dropdown nav-item">
              <a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="fas fa-school"></i><span data-i18n="nav.dash.main">Gestion EVOL</span></a>
            ...
            <li data-menu="dropdown" class="dropdown nav-item">
              <a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="fas fa-school"></i><span data-i18n="nav.dash.main">Gestion Soutien</span></a>
              <ul class="dropdown-menu">
          ...
          <div id="teacherSection" style="display: none;">
            ...
            <li data-menu="dropdown" class="dropdown nav-item "><a href="#" class="nav-link"><i class="fas fa-pencil-ruler"></i><span data-i18n="nav.dash.main">Classe virtuelle</span></a></li>
          ...
          <div id="studentSection" style="display: none;">
            ...
            <li data-menu="dropdown" class="dropdown nav-item "><a href="mes-cours-eleve.php" class="nav-link"><i class="fas fa-book"></i><span data-i18n="nav.dash.main">Mes cours</span></a></li>
          ...
          <div id="studentSoutienSection" style="display: none;">
            ...
            <li data-menu="dropdown" class="dropdown nav-item "><a href="#" class="nav-link" id="virtualClass"><i class="fas fa-pencil-ruler"></i><span data-i18n="nav.dash.main">Classe virtuelle</span></a></li>
            <li data-menu="dropdown" class="dropdown nav-item "><a href="mes-cours-eleve-soutien.php" class="nav-link"><i class="fas fa-book"></i><span data-i18n="nav.dash.main">Mes cours</span></a></li>
      ...
      <div class="row">
        <div class="col-xl-8 offset-xl-2 col-md-10 offset-md-1 col-xs-12">
          <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block"><i class="fas fa-bell"></i> Mes notifications <a href="#" id="help"><i class="fas fa-question-circle inline-block" style="font-weight: 100"></i></a></h3>
          </div>
        </div>
      </div>
              ...
              <div class="card">
                <div class="card-block">
                  <div class="table-responsive">
                    <table class="table table-bordered table-lg text-xs-center">
                      <!-- IMPORTANT, class="list" have to be at tbody -->
                      <tbody class="list" id="tbody-notifications">
                      </tbody>
                      <div class="help-block text-bold-600 font-small-3" style="display:none; text-align:center" id="error-message2">Vous n'avez pas de notifications.</div>
                    </table>
                  </div>
                </div>
              </div>
  ...
  <script src="../../app-assets/js/scripts/pages/notifications.js" type="text/javascript"></script>
