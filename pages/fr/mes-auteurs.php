...
<li class="nav-item hidden-md-up float-xs-right"><a data-toggle="collapse" data-target="#navbar-mobile" class="nav-link open-navbar-container"><i class="icon-ellipsis pe-2x icon-icon-rotate-right-right"></i></a></li>
  ...
  <div class="modal fade text-left" id="modalDisplayUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" style="display: none;" aria-hidden="true">
    ...
    <div class="modal fade text-left" id="modalDisplayContent" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header no-border">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <h3 class="modal-title"  id="contentTitle"> Contenu créé par </h3>
        </div>
        <div class="modal-body" >
        <div class="card collapse-icon accordion-icon-rotate" id="listContent" style="display: none;">

      </div>
          <div id="noContent">L'utilisateur n'a pas créé de contenu pour le moment.</div>
  ...
  <div class="app-content container center-layout mt-2">
    ...
    <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
      ...
      <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block"><i class="fas fa-users"></i> Mes Auteurs </h3>
      </div>
                    ...
                    <table class="table table-bordered" style="text-align: center; vertical-align: middle;">
                      <thead>
                        <tr>
                          ...
                          <th style="padding-left: 0.1%; padding-right: 0.1%;" width='5%'>Contenu créé</th>
  ...
  <script type="text/javascript" src="../../app-assets/js/scripts/pages/mes-auteurs.js"></script>
