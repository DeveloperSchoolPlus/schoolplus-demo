  ...
  if (firebaseUser) {
    ...
    query.get().then(function (doc) {
      if (doc.exists) {
        ...
        {
          document.getElementById('btnParameters').classList.remove('d-none')
          initPlanningSelection();
          initPlaces();
        }
        else if(userCategory == 'teacher')
        {
          document.getElementById('myBreadcumb').innerText = 'Mon planning';
          document.getElementById('btnEmargement').classList.remove('d-none')
          getStudentsEmargement(doc.data().classe);
          initPlaces();
        ...
        {
          document.getElementById('myBreadcumb').innerText = 'Mon planning';
          initCalendar(userCategory, instituteName, doc.data().classe, '' );
        }
