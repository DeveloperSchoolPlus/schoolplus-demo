...
<head>
 ...
 <?php include '../../../bibliotheque/modules/formation/create-formation/css.php' ?>
...
<body class="vertical-layout vertical-compact-menu content-detached-right-sidebar   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-compact-menu" data-col="content-detached-right-sidebar">
 ...
 <?php
    ...
    ?>
 <!-- end vertical-menu -->
 <?php include '../../../bibliotheque/modules/formation/create-formation/main.php' ?>
 ...
 <?php include '../../../bibliotheque/modules/formation/create-formation/scripts.php' ?>
 <script src="create-formation.js"></script>
