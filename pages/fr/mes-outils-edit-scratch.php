...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <?php include '../../../bibliotheque/modules/content/mes-outils-edit-scratch/css.php' ?>
    ...
    ?>
        <!-- end vertical-menu -->
        <?php include '../../../bibliotheque/modules/content/mes-outils-edit-scratch/main.php' ?>
       ...
       <!--  <footer class="footer footer-static footer-dark navbar-border navbar-shadow">
        ...
        <?php include '../../../bibliotheque/modules/content/mes-outils-edit-scratch/scripts.php' ?>
        <script src="mes-outils-edit-scratch.js"></script>
