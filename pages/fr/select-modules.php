...
<head>
 ...
 <?php include '../../../bibliotheque/modules/selectModules/css.php' ?>
...
<body class="vertical-layout vertical-compact-menu content-detached-right-sidebar   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-compact-menu" data-col="content-detached-right-sidebar">
 ...
 <?php
    ...
    ?>
 <!-- end vertical-menu -->
 <?php include '../../../bibliotheque/modules/selectModules/main.php' ?>
 ...
 <?php include '../../../bibliotheque/modules/selectModules/scripts.php' ?>
 <script src="select-modules.js"></script>
