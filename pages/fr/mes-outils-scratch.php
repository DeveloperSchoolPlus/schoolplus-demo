...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <?php include '../../../bibliotheque/modules/content/mes-outils-scratch/css.php' ?>
    ...
    ?>
        ...
        <?php include '../../../bibliotheque/modules/content/mes-outils-scratch/main.php' ?>
       ...
       <!--  <footer class="footer footer-static footer-dark navbar-border navbar-shadow">
        ...
        <?php include '../../../bibliotheque/modules/content/mes-outils-scratch/scripts.php' ?>

        <script src="mes-outils-scratch.js"></script>
    </body>
