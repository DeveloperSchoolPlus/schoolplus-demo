...
<body id="page-body" data-open="hover" data-menu="horizontal-menu" data-col="2-columns" class="horizontal-layout horizontal-menu 2-columns">
          ...
          <div class="col-xs-12">
            <div class="card">
              <div class="card-header no-border-bottom">
                <h2 class="card-title" style="text-align: center;">Statistiques</h2>
                ...
                <div class="card-block">
                  <div class="table-responsive">
                    <table class="table" style="text-align: center; vertical-align: middle;">
                      <thead>
                        <tr>
                          <th style="padding-left: 0.1%; padding-right: 0.1%;" width='33%'>Matière</th>
                          <th style="padding-left: 0.1%; padding-right: 0.1%;" width='33%'>Nombre de chapitres abordés</th>
                          <th style="padding-left: 0.1%; padding-right: 0.1%;" width='33%'>Nombre de cours réalisés</th>
                        </tr>
                      </thead>
                      <tbody id='tableBilan'>
                        <!-- <tr>
  ...
  <script src="../../app-assets/js/scripts/pages/bilan-soutien.js"></script>
