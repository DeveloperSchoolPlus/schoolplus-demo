...
<li class="nav-item hidden-md-up float-xs-right"><a data-toggle="collapse" data-target="#navbar-mobile" class="nav-link open-navbar-container"><i class="icon-ellipsis pe-2x icon-icon-rotate-right-right"></i></a></li>
      ...
      <div class="modal-content">
        <div class="modal-header no-border">
          ...
          <div class="text-xs-center">
            ...
            <!-- <div class="text-xs-center">
                                <button class="btn bg-school-plus mb-1 mr-1 text-bold-600" id="mail_THV5Or2CBnYgIHAadATdg3NWE9u2" onclick="sendMail(this.id)"><i class="fas fa-envelope"></i> Contacter</button>
  ...
  <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
      ...
      <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block"><i class="fas fa-users"></i> Mes Organisations </h3>
      </div>
  ...
  <script type="text/javascript" src="../../app-assets/js/scripts/pages/mes-organisations.js"></script>
