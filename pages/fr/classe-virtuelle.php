...
<head>
  ...
  <meta name="description" content="The app that motivates all your riders to ride more.">
  <meta name="keywords" content="action sports tracker, surfschool, surf, skate, snowboard, ride, ridecoin, virtual coaching">
  <meta name="author" content="BYTHEWAVE Technologies">
  <title>School +</title>
  ...
  <div class="app-content container center-layout mt-2">
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block"><i class="fas fa-pencil-ruler"></i> Classe virtuelle <a href="#" id="help"><i class="fas fa-question-circle inline-block" style="font-weight: 100"></i></a></h3>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-block">
                <div class="card-body">
                  ...
                  <h5 id="connectLabel"></h5>

                  <div class="container">
                    <div class="row">
                  <div id='sketchpadA' class="sketchpad"></div>
</div>
<div class="row">
                  <div id='sketchpadB' class="sketchpad"></div>
</div>
</div>
                </div>
              </div>
  ...
  <footer class="footer footer-static footer-transparent" style="background:lightgray">
    <ul class="nav navbar-nav ml-1">
      <li class="nav-item"><a href="faq.php" class="nav-link text-muted">Foire aux questions</a></li>
  ...
  <script src="../../sketchpad/dist/sketchpad.js"></script>
